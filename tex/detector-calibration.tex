...
\Delta t > 0$ and the contribution of background sources (dark current) is
negligible for the considered exposure times (shorter than one millisecond).
...
\begin{align}
  ...
  &\quad+ N^\Tag{led}\,\Paren*{
    \frac{v^\Tag{led}_j + \Paren*{m^\Tag{led}_j - z_j - x_j}^2}
         {x_j/g_j + \sigma^2_j}
  ...
  &= g_j\,\Paren*{
    N^\Tag{dark}\,\frac{v^\Tag{dark}_j + \Paren*{m^\Tag{dark}_j - z_j}^2}
                       {u_j} +
    N^\Tag{led}\,\frac{v^\Tag{led}_j + \Paren*{m^\Tag{led}_j - z_j - x_j}^2}
                      {u_j + x_j}
  } \notag\\
  &\quad - \Paren*{N^\Tag{dark} + N^\Tag{led}}\log g_j
    + N^\Tag{dark}\,\log u_j
    + N^\Tag{led}\,\log\Paren*{u_j + x_j}
\end{align}
with $x_j = c^\Tag{led}_j\,\Delta t$ and $u_j = g_j\,\sigma^2_j$ as before
...
\begin{align}
  ...
  &= \frac{
    ...
    \frac{N^\Tag{led}\,\Paren*{m^\Tag{led}_j - xj}}{u + x}
  }{
    \frac{N^\Tag{dark}}{u} +
    \frac{N^\Tag{led}}{u + x}
  } \, .
...
\begin{align}
  ...
  &= \frac{
    ...
    N^\Tag{dark}\,\frac{
      ...
      v^\Tag{led}_j + \Paren*{m^\Tag{led}_j - z^+_j(u,x) - x}^2
    }{
      u + x
    }
  } \, .
...
\begin{align}
  ...
  &\quad + \frac{N^\Tag{led}}{u + x} - N^\Tag{led}\,g^+_j(u,x)\,\frac{
      v^\Tag{led}_j + \Paren*{m^\Tag{led}_j - z^+_j(u,x) - x}^2
    }{
      \Paren*{u + x}^2
    }
  ...
  &= 2\,N^\Tag{led}\,g^+_j(u,x)\,\frac{
       z^+_j(u,x) + x - m^\Tag{led}_j
    }{
      u + x
    } \notag\\
  &\quad + \frac{N^\Tag{led}}{u + x} - N^\Tag{led}\,g^+_j(u,x)\,\frac{
